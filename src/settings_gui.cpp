...
struct GameOptionsWindow : Window {
	...
	std::string GetWidgetString(WidgetID widget, StringID stringid) const override
	{
		switch (widget) {
			...
			case WID_GO_RENDER_3D_TEXT:
				return GetToggleString(STR_CONFIG_SETTING_RENDER_3D, WID_GO_RENDER_3D_BUTTON);
	...
	void OnClick([[maybe_unused]] Point pt, WidgetID widget, [[maybe_unused]] int click_count) override
	{
		...
		switch (widget) {
			...
			case WID_GO_RENDER_3D_BUTTON:
				_settings_client.gui.render_3d = !_settings_client.gui.render_3d;
				this->SetWidgetLoweredState(WID_GO_RENDER_3D_BUTTON, _settings_client.gui.render_3d);
				this->SetWidgetDirty(WID_GO_RENDER_3D_BUTTON);
				this->SetWidgetDirty(WID_GO_RENDER_3D_TEXT);
...
#endif
							NWidget(NWID_HORIZONTAL), SetPIP(0, WidgetDimensions::unscaled.hsep_wide, 0),
								NWidget(WWT_BOOLBTN, GAME_OPTIONS_BACKGROUND, WID_GO_RENDER_3D_BUTTON), SetAlternateColourTip(GAME_OPTIONS_BUTTON, STR_CONFIG_SETTING_RENDER_3D_HELPTEXT),
								NWidget(WWT_TEXT, INVALID_COLOUR, WID_GO_RENDER_3D_TEXT), SetFill(1, 0), SetResize(1, 0), SetTextStyle(GAME_OPTIONS_LABEL),
							EndContainer(),
							NWidget(NWID_HORIZONTAL),
